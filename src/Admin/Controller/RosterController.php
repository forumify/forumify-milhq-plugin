...
{
    protected ?string $permissionView = 'milhq.admin.organization.rosters.view';
    protected ?string $permissionCreate = 'milhq.admin.organization.rosters.create';
    protected ?string $permissionEdit = 'milhq.admin.organization.rosters.manage';
    protected ?string $permissionDelete = 'milhq.admin.organization.rosters.delete';
